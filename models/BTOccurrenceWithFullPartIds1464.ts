 ...
 */
export interface BTOccurrenceWithFullPartIds1464 extends BTOccurrence74 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTOccurrenceWithFullPartIds1464
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTOccurrenceWithFullPartIds1464 interface.
 */
export function instanceOfBTOccurrenceWithFullPartIds1464(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTOccurrenceWithFullPartIds1464FromJSON(json: any): BTOccurrenceWithFullPartIds1464 {
    return BTOccurrenceWithFullPartIds1464FromJSONTyped(json, false);
}

export function BTOccurrenceWithFullPartIds1464FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTOccurrenceWithFullPartIds1464 {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        ...BTOccurrence74FromJSONTyped(json, ignoreDiscriminator),
...
export function BTOccurrenceWithFullPartIds1464ToJSON(value?: BTOccurrenceWithFullPartIds1464 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
