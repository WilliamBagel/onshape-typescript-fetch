 ...
 */
export interface BTParameterSpecProgress3078 extends BTReadOnlyParameterSpec1889 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTParameterSpecProgress3078
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTParameterSpecProgress3078 interface.
 */
export function instanceOfBTParameterSpecProgress3078(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTParameterSpecProgress3078FromJSON(json: any): BTParameterSpecProgress3078 {
    return BTParameterSpecProgress3078FromJSONTyped(json, false);
}

export function BTParameterSpecProgress3078FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTParameterSpecProgress3078 {
...
export function BTParameterSpecProgress3078ToJSON(value?: BTParameterSpecProgress3078 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
