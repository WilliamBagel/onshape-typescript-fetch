 ...
 * 
 * @export
 * @interface BTMMateRelation1412
 */
export interface BTMMateRelation1412 extends BTMAssemblyFeature887 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTMMateRelation1412
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTMMateRelation1412 interface.
 */
export function instanceOfBTMMateRelation1412(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTMMateRelation1412FromJSON(json: any): BTMMateRelation1412 {
    return BTMMateRelation1412FromJSONTyped(json, false);
}

export function BTMMateRelation1412FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTMMateRelation1412 {
...
export function BTMMateRelation1412ToJSON(value?: BTMMateRelation1412 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
