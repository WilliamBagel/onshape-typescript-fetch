 ...
 */
export interface BTParameterSpecBoolean170 extends BTParameterSpec6 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTParameterSpecBoolean170
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTParameterSpecBoolean170 interface.
 */
export function instanceOfBTParameterSpecBoolean170(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTParameterSpecBoolean170FromJSON(json: any): BTParameterSpecBoolean170 {
    return BTParameterSpecBoolean170FromJSONTyped(json, false);
}

export function BTParameterSpecBoolean170FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTParameterSpecBoolean170 {
...
export function BTParameterSpecBoolean170ToJSON(value?: BTParameterSpecBoolean170 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
