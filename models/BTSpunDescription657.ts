 ...
 */
export interface BTSpunDescription657 extends BTSurfaceDescription1564 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTSpunDescription657
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTSpunDescription657 interface.
 */
export function instanceOfBTSpunDescription657(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTSpunDescription657FromJSON(json: any): BTSpunDescription657 {
    return BTSpunDescription657FromJSONTyped(json, false);
}

export function BTSpunDescription657FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTSpunDescription657 {
...
export function BTSpunDescription657ToJSON(value?: BTSpunDescription657 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
