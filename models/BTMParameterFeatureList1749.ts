...
/**
 * Check if a given object implements the BTMParameterFeatureList1749 interface.
 */
export function instanceOfBTMParameterFeatureList1749(value: object): boolean {
    let isInstance = true;
