 ...
 */
export interface BTMAssemblyFeature12218 extends BTMAssemblyFeature887 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTMAssemblyFeature12218
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTMAssemblyFeature12218 interface.
 */
export function instanceOfBTMAssemblyFeature12218(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTMAssemblyFeature12218FromJSON(json: any): BTMAssemblyFeature12218 {
    return BTMAssemblyFeature12218FromJSONTyped(json, false);
}

export function BTMAssemblyFeature12218FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTMAssemblyFeature12218 {
...
export function BTMAssemblyFeature12218ToJSON(value?: BTMAssemblyFeature12218 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
