 ...
 */
export interface BTJEditDelete1992 extends BTJEdit3734 {
    /**
     * Type of JSON object.
     * @type {string}
...
/**
 * Check if a given object implements the BTJEditDelete1992 interface.
 */
...
export function BTJEditDelete1992FromJSON(json: any): BTJEditDelete1992 {
    return BTJEditDelete1992FromJSONTyped(json, false);
}

export function BTJEditDelete1992FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTJEditDelete1992 {
...
export function BTJEditDelete1992ToJSON(value?: BTJEditDelete1992 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
