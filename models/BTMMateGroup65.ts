 ...
 */
export interface BTMMateGroup65 extends BTMAssemblyFeature887 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTMMateGroup65
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTMMateGroup65 interface.
 */
export function instanceOfBTMMateGroup65(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTMMateGroup65FromJSON(json: any): BTMMateGroup65 {
    return BTMMateGroup65FromJSONTyped(json, false);
}

export function BTMMateGroup65FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTMMateGroup65 {
...
export function BTMMateGroup65ToJSON(value?: BTMMateGroup65 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
