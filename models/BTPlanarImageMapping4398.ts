 ...
 * 
 * @export
 * @interface BTPlanarImageMapping4398
 */
export interface BTPlanarImageMapping4398 extends BTImageMapping3821 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTPlanarImageMapping4398
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTPlanarImageMapping4398 interface.
 */
export function instanceOfBTPlanarImageMapping4398(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTPlanarImageMapping4398FromJSON(json: any): BTPlanarImageMapping4398 {
    return BTPlanarImageMapping4398FromJSONTyped(json, false);
}

export function BTPlanarImageMapping4398FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTPlanarImageMapping4398 {
...
export function BTPlanarImageMapping4398ToJSON(value?: BTPlanarImageMapping4398 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
