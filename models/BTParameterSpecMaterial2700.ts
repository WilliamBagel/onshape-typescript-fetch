 ...
 * 
 * @export
 * @interface BTParameterSpecMaterial2700
 */
export interface BTParameterSpecMaterial2700 extends BTParameterSpec6 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTParameterSpecMaterial2700
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTParameterSpecMaterial2700 interface.
 */
export function instanceOfBTParameterSpecMaterial2700(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTParameterSpecMaterial2700FromJSON(json: any): BTParameterSpecMaterial2700 {
    return BTParameterSpecMaterial2700FromJSONTyped(json, false);
}

export function BTParameterSpecMaterial2700FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTParameterSpecMaterial2700 {
...
export function BTParameterSpecMaterial2700ToJSON(value?: BTParameterSpecMaterial2700 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
