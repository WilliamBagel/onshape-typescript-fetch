 ...
 */
export interface BTPStatementAssignment270 extends BTPStatement269 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTPStatementAssignment270
     */
    btType?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BTPStatementAssignment270 interface.
 */
export function instanceOfBTPStatementAssignment270(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTPStatementAssignment270FromJSON(json: any): BTPStatementAssignment270 {
    return BTPStatementAssignment270FromJSONTyped(json, false);
}

export function BTPStatementAssignment270FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTPStatementAssignment270 {
...
export function BTPStatementAssignment270ToJSON(value?: BTPStatementAssignment270 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
