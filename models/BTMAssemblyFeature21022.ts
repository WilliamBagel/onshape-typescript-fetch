 ...
 */
export interface BTMAssemblyFeature21022 extends BTMAssemblyFeature887 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTMAssemblyFeature21022
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTMAssemblyFeature21022 interface.
 */
export function instanceOfBTMAssemblyFeature21022(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTMAssemblyFeature21022FromJSON(json: any): BTMAssemblyFeature21022 {
    return BTMAssemblyFeature21022FromJSONTyped(json, false);
}

export function BTMAssemblyFeature21022FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTMAssemblyFeature21022 {
...
export function BTMAssemblyFeature21022ToJSON(value?: BTMAssemblyFeature21022 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
