 ...
 */
export interface BTParameterSpecDerived736 extends BTParameterSpec6 {
    /**
     * Type of JSON object.
     * @type {string}
     * @memberof BTParameterSpecDerived736
     */
    btType?: string;
}

/**
 * Check if a given object implements the BTParameterSpecDerived736 interface.
 */
export function instanceOfBTParameterSpecDerived736(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BTParameterSpecDerived736FromJSON(json: any): BTParameterSpecDerived736 {
    return BTParameterSpecDerived736FromJSONTyped(json, false);
}

export function BTParameterSpecDerived736FromJSONTyped(json: any, ignoreDiscriminator: boolean): BTParameterSpecDerived736 {
...
export function BTParameterSpecDerived736ToJSON(value?: BTParameterSpecDerived736 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
